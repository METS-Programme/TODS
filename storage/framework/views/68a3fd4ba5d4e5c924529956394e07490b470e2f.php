                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="form-group">
                                                        <?php echo Form::text('tool_name_and_code', null, array('placeholder' => 'Tool name and code','class' => 'form-control')); ?>

                                                    </div>
                                                </td>
                                                <td>
                                                    <?php echo Form::text('quantity_delivered', null, array('placeholder' => 'quantity delivered','class' => 'form-control')); ?>

                                                </td>
                                                <td>
                                                    <?php echo Form::text('storage_location', null, array('placeholder' => 'storage location','class' => 'form-control')); ?>
