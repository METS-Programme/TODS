...
<aside class="main-sidebar">
  ...
  <button type='submit' name='search' id='search-btn' class="btn btn-flat"><i class="fa fa-search"></i></button>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                <a href="#"> <i class="fa fa-edit"></i> <span>MANAGE CONTENT</span> <i class="fa fa-angle-left pull-right"></i></a>
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(url('printorderCRUD')); ?>"><i class="fa fa-circle-o text-red"></i><span>Print Orders</span></a></li>
                    <li><a href="<?php echo e(url('deliveryCRUD')); ?>"><i class="fa fa-circle-o text-yellow"></i><span>Print Order Deliveries</span></a></li>
                    <li><a href="<?php echo e(url('allocations')); ?>"><i class="fa fa-circle-o text-aqua"></i><span>Allocation</span></a></li>
                    <li><a href="<?php echo e(url('tool-distribution')); ?>"><i class="fa fa-circle-o text-aqua"></i><span>Tool Distribution</span></a></li>
                    <li><a href="<?php echo e(url('tool-ordering')); ?>"><i class="fa fa-circle-o text-blue"></i><span>Tool Ordering</span></a></li>
                    <li><a href="<?php echo e(url('tools-picked')); ?>"><i class="fa fa-circle-o text-green"></i><span>Tool Pickup</span></a></li>
