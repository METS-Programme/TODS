...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="/home" class="logo"><b>TODS</b></a>
            ...
            <ul class="nav navbar-nav">
                ...
                <?php /*<li class="dropdown user user-menu">*/ ?>
                    ...
                    <?php /*<a href="#" class="dropdown-toggle" data-toggle="dropdown">*/ ?>
                        ...
                        <?php /*<img src="<?php echo e(asset("/bower_components/AdminLTE/dist/img/avatar.png")); ?>" class="user-image" alt="User Image"/>*/ ?>
                        <?php /*<!-- hidden-xs hides the username on small devices so only the image appears. -->*/ ?>
                        <?php /*<span class="hidden-xs">Admin</span>*/ ?>
                    <?php /*</a>*/ ?>
                    <?php /*<ul class="dropdown-menu">*/ ?>
                        ...
                        <?php /*<li class="user-header">*/ ?>
                            ...
                            <?php /*<p>*/ ?>
                                <?php /*Admin - METS Staff*/ ?>
                                <?php /*<small>Full Access</small>*/ ?>
                            <?php /*</p>*/ ?>
                        <?php /*</li>*/ ?>
                        <?php /*<!-- Menu Footer-->*/ ?>
                        <?php /*<li class="user-footer">*/ ?>
                            <?php /*<div class="pull-left">*/ ?>
                                <?php /*<a href="#" class="btn btn-default btn-flat">Profile</a>*/ ?>
                            <?php /*</div>*/ ?>
                            <?php /*<div class="pull-right">*/ ?>
                                <?php /*<a href="/" class="btn btn-default btn-flat">Sign out</a>*/ ?>
                            <?php /*</div>*/ ?>
                        <?php /*</li>*/ ?>
                    <?php /*</ul>*/ ?>
                <?php /*</li>*/ ?>
