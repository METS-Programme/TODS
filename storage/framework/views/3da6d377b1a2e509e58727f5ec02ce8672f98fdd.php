        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="/bower_components/AdminLTE/dist/img/baylor-uganda.jpeg" alt="User profile picture">

              <h3 class="profile-username text-center">Baylor Uganda</h3>

              <p class="text-muted text-center">Comprehensive IP</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Regions</b> <a class="pull-right">2</a>
                </li>
                <li class="list-group-item">
                  <b>Districts</b> <a class="pull-right">19</a>
                </li>
                <li class="list-group-item">
                  <b>Sub-Counties</b> <a class="pull-right">112</a>
                </li>
                <li class="list-group-item">
                  <b>Health Facilities</b> <a class="pull-right">500</a>
                </li>
              </ul>
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <strong><i class="fa fa-book margin-r-5"></i> Program Areas</strong>
              ...
              <p class="text-muted">
                ...
                Tel: 0417-119100/200/125
                Email: admin@baylor-uganda.org
                www.baylor-uganda.org
              </p>
